...
printCanoncialDangerousIngredientList([H|[]]) :- !, write(H).
printCanoncialDangerousIngredientList([H|T]) :- write(H), write(","), printCanoncialDangerousIngredientList(T).

solve(File) :-
  loadData(File),
  resolveAllergens,
  findall(Allergen, allergen(Allergen), Allergens),
  sort(Allergens, SortedAllergens),
  maplist(allergen_ingredient, SortedAllergens, IngredientsSortedByAllergen),
  !, printCanoncialDangerousIngredientList(IngredientsSortedByAllergen).
